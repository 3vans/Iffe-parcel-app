...
import { Home, Users, CheckSquare, FileText, Image as ImageIcon, MessageSquare, Settings, LayoutDashboard, Database, Map, Percent, Globe, CalendarClock, Mail } from 'lucide-react';
...
const adminNavItems = [
  ...
  { href: '/admin/inquiries', label: 'Inquiries & Leads', icon: Mail },
  { href: '/admin/inventory', label: 'Inventory & Prices', icon: Database },
  { href: '/admin/expeditions', label: 'Expeditions & Dates', icon: Map },
