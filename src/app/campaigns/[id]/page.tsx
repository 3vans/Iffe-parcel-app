...
const mockCampaignsData: Campaign[] = [
    // Existing detailed campaigns
    {
        ...
        storyline: 'Few wildlife experiences rival the authenticity and emotional impact of gorilla trekking in Bwindi. With strictly limited daily permits, the experience is exclusive, well-managed, and focused on conservation. This tour offers guaranteed permits, expert local guides and rangers, ethical low-impact travel, carefully chosen accommodation near the park, and a rare, life-changing encounter found nowhere else on Earth',
