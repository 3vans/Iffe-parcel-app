...
const mockCampaignsData: Campaign[] = [
    // Existing detailed campaigns
    {
        ...
        storyline: 'Guided by expert local trackers and park rangers, you’ll journey deep into the forest with the assurance of guaranteed permits and ethical, low-impact tourism. Every step supports conservation efforts and the communities dedicated to protecting these endangered primates.',
