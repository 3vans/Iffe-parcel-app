...
const mockVideoData: VideoItem[] = [
  ...
  { id: 'v3', title: 'Clean Water Campaign Impact Story', description: 'See how your contributions are changing lives.', thumbnailUrl: 'https://placehold.co/600x338.png', dataAiHint: 'community water pump', youtubeVideoId: 'rokGy0huYEA', category: 'Campaigns', duration: '3:15' },
