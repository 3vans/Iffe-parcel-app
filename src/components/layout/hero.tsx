...
const TornPaperSVG = () => (
  ...
  >
    <path
      ...
      className="fill-old-paper/50 dark:fill-background/50"
    />
  </svg>
);
  ...
  return (
    <div ref={ref} className={cn('relative w-full h-[60vh] min-h-[400px] md:min-h-[500px] overflow-hidden rounded-lg shadow-2xl scroll-animate bg-background', isVisible && 'scroll-animate-in')}>
      ...
      <div className="relative h-full flex items-center z-10">
        {/* Left Panel */}
        <div className="relative w-full md:w-1/2 lg:w-2/5 h-full flex flex-col justify-center bg-old-paper/50 dark:bg-background/50 backdrop-blur-md p-8 md:p-12">
